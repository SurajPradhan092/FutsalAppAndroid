...
class FutsaldetailActivity : AppCompatActivity() {
    ...
    private lateinit var fmail: TextView
    ...
    private val time = arrayOf(
            "Select time", "06 am", "08 am", "09 am", "03 pm", "05 pm", "07 pm"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (futsal !=null) {
            ...
            fmail.setText("Emailid: " + futsal.fmail.toString())
    ...
    private fun book() {
        ...
        val fmail = futsal?.fmail.toString()
        val futsalbook = FutsalBook(futsalname = futsalname, futsalid = futsalid,
                date = date, time = time, username = username, userid = userid, email = email, fmail = fmail )
