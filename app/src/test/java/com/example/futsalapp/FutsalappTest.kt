...
//    private lateinit var PostRepository: PostRepository
    ...
    fun checkLogin() = runBlocking {
        ...
        val response = userRepository.userLogin("suraj1", "password")
    ...
    fun futsalBooking() = runBlocking {
        ...
        val futsalbook = FutsalBook(futsalname = "Jadibuti Futsal", futsalid = "465646546",
                date = "02/02/2021", time = "06 am", username = "suraj1", userid = "54684653")
...
//        userRepository = UserRepository()
//
//        ServiceBuilder.token= "Bearer" + userRepository.userLogin("suraj", "password").token
...
//    }
    ...
    fun bookingDelete() = runBlocking {
        FutsalRepository = FutsalRepository()
        userRepository = UserRepository()
        ServiceBuilder.token= "Bearer" + userRepository.userLogin("suraj1", "password").token
